...
| **2** | App shell | **Partial** — maintenance **`erp-master`** + **Lists** (**▤**) icon opens **`#catalog`**; dispatch + **settings** + hub strips link workspaces; **`index.html`** hub header **`erp-help-tip`**; **`system-smoke.mjs`** GET **`/index.html`** (**changelog 67**); spec copy/dimensions **Future**. |
