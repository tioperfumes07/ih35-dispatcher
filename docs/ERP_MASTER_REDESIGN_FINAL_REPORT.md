...
| **Rule 24 (partial)** | One-line **QuickBooks** status strip on **banking, settings, fuel, index**, and **maintenance** (main column `#erpConnectionStrip` on load) via `erpMountConnectionStrip`. Sidebar still holds richer **QBO / Samsara** text. |
