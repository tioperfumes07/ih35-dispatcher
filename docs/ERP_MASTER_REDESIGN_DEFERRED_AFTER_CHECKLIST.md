...
- **2026-04-18 — GitHub Actions Rule 0:** **[`.github/workflows/rule0-check.yml`](../.github/workflows/rule0-check.yml)** runs **`npm ci`** + **`npm test`** (`**rule0:check**`); **`README`** + **FINAL_REPORT** § P0 note that smoke stays local (**`qa:automated`**).
