...
- **Partial:** Reports hub shell in maintenance; **TMS**, **QBO**, **sync**, **IFTA**, **Maintenance spend by unit**, **Team activity & security**, **Maintenance detailed report** tab titles include **`erp-help-tip`** (IFTA / maint detailed body copy shortened + tip). “All reports on one page / remove links from other sidebars” — **not fully enforced** in this pass.
