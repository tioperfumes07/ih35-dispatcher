  ...
  <div class="erp-rfp__body" style="padding:10px;display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:10px 14px">
    ...
    ${
      show.has('partPositionsPick')
        ...
        <textarea class="qb-in erp-rfp-pos-lines" rows="3" style="height:17px;width:100%;max-width:560px;margin-top:4px;font-size:9px;resize:vertical;font-family:Arial,sans-serif;border:0.5px solid #d0d4da;border-radius:2px;box-sizing:border-box;" placeholder="e.g. LFO&#10;steer L"></textarea>
      </div>`
        : ''
    }
