...
(function (global) {
  ...
  function driverSettlementHtml() {
    ...
    return (
      ...
      renderDateBarHtml('ds_hist', '<span class="qb-l">Driver</span><input class="qb-in" disabled placeholder="Filter" style="height:17px;padding:0 5px;font-size:9px;font-family:Arial,sans-serif;border:0.5px solid #d0d4da;border-radius:2px;box-sizing:border-box;width:100%"/>') +
  ...
  function loadTmsHtml() {
    ...
    return (
      ...
      '</div></div>' +
      renderDateBarHtml('lt_hist', '<span class="qb-l">Status</span><select class="qb-in" style="height:17px;padding:0 3px;font-size:9px;font-family:Arial,sans-serif;border:0.5px solid #d0d4da;border-radius:2px;box-sizing:border-box;width:100%"><option>All</option></select>') +
