...
export function defaultIntegrityThresholds() {
  return {
    ...
    maxMonthlyCostPerUnit: 5000,
    maxServiceRecordsPerUnit60d: 7,
...
/** Same key order as Settings → Integrity thresholds; labels match that UI. */
const INTEGRITY_THRESHOLD_DESCRIPTOR_LIST = [
  ...
  { key: 'tireCostAnomalyMult', label: 'Tire invoice cost anomaly (× fleet average)', unitLabel: 'multiplier' },
  { key: 'maxFleetTiresPerMonth', label: 'Fleet tire services per calendar month', unitLabel: 'count' },
  ...
  { key: 'maxRepairCostDriver90d', label: 'Max driver-linked repair spend (90 days)', unitLabel: 'USD' },
  { key: 'maxRepairsSameDriverUnit60d', label: 'Same driver + unit repairs (60 days)', unitLabel: 'count' },
  { key: 'fuelConsumptionIncreasePct', label: 'Fuel volume spike vs baseline (%)', unitLabel: '%' },
  { key: 'unusualGallonsMult', label: 'Unusual single fill vs driver/unit average', unitLabel: 'multiplier' },
  { key: 'fuelPriceSpikePct', label: 'Price per gallon vs 30-day fleet average (%)', unitLabel: '%' },
  { key: 'serviceCostAnomalyMult', label: 'Service cost vs fleet average for service type', unitLabel: 'multiplier' },
  { key: 'maxMonthlyCostPerUnit', label: 'Max maintenance spend per unit per month', unitLabel: 'USD' },
  { key: 'maxServiceRecordsPerUnit60d', label: 'Non-PM service records per unit (60 days)', unitLabel: 'count' },
  { key: 'vendorInvoiceIncreasePct', label: 'Vendor invoice vs that vendor’s history (%)', unitLabel: '%' },
  { key: 'accidentQuarterlyCostUsd', label: 'Accident repair cost cap (current quarter)', unitLabel: 'USD' },
  { key: 'accidentQuarterlyCostYoYPct', label: 'Accident cost vs same quarter prior year (%)', unitLabel: '%' }
];
  ...
  return [
    ...
    },
    {
      ...
      rules: [
        ...
        {
          code: 'M4',
          summary: 'Vendor line > vendor’s historical average for service type × (1 + vendorInvoiceIncreasePct/100).',
