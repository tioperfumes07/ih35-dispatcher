...
export const defaultIntegrityThresholds = {
  ...INTEGRITY_LIMITS
};
...
export function evaluateIntegrityCheck(units = [], options = {}) {
  const thresholds = mergeIntegrityThresholds(options);
  return summarizeFleetIntegrity(units, thresholds);
}
