...
import { formatFleetPaceDueLabel } from './fleet-mileage-settings.mjs';
    ...
    case 'a4-pm-schedule': {
      ...
      for (const u of units) {
        ...
        if (nextDue != null && cur != null && Number.isFinite(nextDue) && Number.isFinite(cur)) {
          ...
          fleetPaceEta = formatFleetPaceDueLabel(mr, fleetAvg);
        }
        rows.push({
          unit: u,
          makeModel: fleet.ymm || '',
      ...
      return {
        ...
        columns: [
          ...
          { key: 'fleetPaceEta', label: 'Due in (fleet pace)' },
        ...
        meta: {
          ...
          disclaimer: `Fleet average pace: ${fleetAvg.toLocaleString(
            'en-US'
          )} mi per truck per month. PM colors: green if miles remaining > 8,000; blue if 3,000–8,000; amber if 0–3,000; red if overdue. “Due in” uses fleet pace: >2 months → months; 1–8 weeks → weeks; <1 week → days. Catalog months = FLOOR(miles ÷ fleet avg), minimum 1.`
        }
      };
    }
